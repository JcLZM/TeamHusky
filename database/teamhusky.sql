...
(106, 56, NULL, 6,'5 Shocking Ways About drinking alcohol','It ought to be axiomatic in this country that every man must devote a reasonable share of his time to doing his duty in the Political life of the community.','Pending Review'),
...
(117, 67, NULL,17,'29 Mistakes Most careless mistakes beginners Often Commit (And How To Avoid Them)','Cathargo Delenda Est!','Pending Review'),
...
(131, 56, NULL,31,'13 Shocking Tricks About Christmas','Were still pioneers. They, the members of the Challenger crew, were pioneers.','Pending Review'),
...
(133, 58, NULL,33,'Are You Ready To sleep? Here is How','I know it is hard to understand, but sometimes painful things like this happen.','Pending Review'),
...
(135, 60, NULL,35,'11 Shocking Tricks About Chinese new year','But has the last word been said? Must hope disappear? Is defeat final? No!','Pending Review'),
...
(172, 72, NULL,72,'CSIT314: The Ultimate Things List','Blessed are they that mourn: for they shall be comforted.','Pending Review'),
...
(176, 51, NULL,76,'CSIT314 project Resolved In Just 25 Steps','Blessed are the pure in heart: for they shall see God.','Pending Review'),
(177, 52, NULL,77,'Top 11 Things Behind CSIT314','Blessed are the peacemakers: for they shall be called the children of God.','Pending Review'),
...
(194, 69, NULL,94,'Best 10 english Tactics For 2022','The poorest way to face life is to face it with a sneer. ','Pending Review'),
(195, 70, NULL,95,'Best 10 science Tactics For 2022','There are many men who feel a kind of twister pride in cynicism; ','Pending Review'),
...
(5,5,2,2,"If I had to live my life again, I'd make the same mistakes, only sooner."),
(6,6,4,0,"I want to be in Glee, but I'm told I'm not famous enough to be a cameo yet."),
(7,7,3,0,"I've had a lot of experience in independent film, and about how to choose. You've got to be very discerning about where you put your five bucks, and where you cut and what you don't cut."),
(8,8,4,1,"I'm a history nut."),
(9,9,2,-1,"Democracy is ever eager for rapid progress, and the only progress which can be rapid is progress down hill."),
(10,10,5,-3,"I don't want to achieve immortality through my work ... I want to achieve it through not dying."),
(11,11,3,0,"I drive an electric car."),
(12,12,4,1,"Writers should be read but not seen. Rarely are they a winsome sight."),
(13,13,2,-3,"To limit the press is to insult a nation; to prohibit reading of certain books is to declare the inhabitants to be either fools or slaves."),
(14,14,1,-3,"I think that, as with marriage, you just know when it's time to have kids."),
(15,15,5,-1,"The fact is that people are good, Give people affection and security, and they will give affection and be secure in their feelings and their behavior."),
(16,16,2,0,"Now this is not the end. It is not even the beginning of the end. But it is, perhaps, the end of the beginning."),
(17,17,3,0,"I'd rather drive the yellow brick road, you wouldn't happen to know of a rental car place around."),
(18,18,5,0,"If I had been on Bowling for Dollars, I'd wind up owing them money."),
(19,19,3,0,"Dying is an art, like everything else. I do it exceptionally well. I do it so it feels like hell. I do it so it feels real. I guess you could say I've a call."),
(20,20,3,-2,"Justice remains the greatest power on earth. To that tremendous power alone will we submit."),
(21,21,3,1,"Best to take the moment present as a present for the moment."),
(22,22,2,3,"Death is always and under all circumtances a tragedy, for if it is not, then it means that life itself has become one."),
...
(30,30,3,0,"If I had to live my life again, I'd make the same mistakes, only sooner."),
(31,31,1,3,"I want to be in Glee, but I'm told I'm not famous enough to be a cameo yet."),
(32,32,2,1,"I've had a lot of experience in independent film, and about how to choose. You've got to be very discerning about where you put your five bucks, and where you cut and what you don't cut."),
(33,33,3,1,"I'm a history nut."),
(34,34,3,-2,"Democracy is ever eager for rapid progress, and the only progress which can be rapid is progress down hill."),
(35,35,5,0,"I don't want to achieve immortality through my work ... I want to achieve it through not dying."),
(36,36,5,2,"I drive an electric car."),
(37,37,2,1,"Writers should be read but not seen. Rarely are they a winsome sight."),
(38,38,4,3,"To limit the press is to insult a nation; to prohibit reading of certain books is to declare the inhabitants to be either fools or slaves."),
(39,39,2,2,"I think that, as with marriage, you just know when it's time to have kids."),
(40,40,5,-1,"The fact is that people are good, Give people affection and security, and they will give affection and be secure in their feelings and their behavior."),
(41,41,4,-3,"Now this is not the end. It is not even the beginning of the end. But it is, perhaps, the end of the beginning."),
(42,42,2,2,"I'd rather drive the yellow brick road, you wouldn't happen to know of a rental car place around."),
(43,43,3,1,"If I had been on Bowling for Dollars, I'd wind up owing them money."),
(44,44,2,-3,"Dying is an art, like everything else. I do it exceptionally well. I do it so it feels like hell. I do it so it feels real. I guess you could say I've a call."),
(45,45,5,-3,"Justice remains the greatest power on earth. To that tremendous power alone will we submit."),
(46,46,4,1,"Best to take the moment present as a present for the moment."),
(47,47,3,-3,"Death is always and under all circumtances a tragedy, for if it is not, then it means that life itself has become one."),
...
(55,55,3,2,"If I had to live my life again, I'd make the same mistakes, only sooner."),
(56,56,3,0,"I want to be in Glee, but I'm told I'm not famous enough to be a cameo yet."),
(57,57,2,2,"I've had a lot of experience in independent film, and about how to choose. You've got to be very discerning about where you put your five bucks, and where you cut and what you don't cut."),
(58,58,4,3,"I'm a history nut."),
(59,59,2,-1,"Democracy is ever eager for rapid progress, and the only progress which can be rapid is progress down hill."),
(60,60,5,-2,"I don't want to achieve immortality through my work ... I want to achieve it through not dying."),
(61,61,5,-3,"I drive an electric car."),
(62,62,5,-2,"Writers should be read but not seen. Rarely are they a winsome sight."),
(63,63,1,3,"To limit the press is to insult a nation; to prohibit reading of certain books is to declare the inhabitants to be either fools or slaves."),
(64,64,3,2,"I think that, as with marriage, you just know when it's time to have kids."),
(65,65,2,-1,"The fact is that people are good, Give people affection and security, and they will give affection and be secure in their feelings and their behavior."),
(66,66,4,-1,"Now this is not the end. It is not even the beginning of the end. But it is, perhaps, the end of the beginning."),
(67,67,3,1,"I'd rather drive the yellow brick road, you wouldn't happen to know of a rental car place around."),
(68,68,3,3,"If I had been on Bowling for Dollars, I'd wind up owing them money."),
(69,69,5,-2,"Dying is an art, like everything else. I do it exceptionally well. I do it so it feels like hell. I do it so it feels real. I guess you could say I've a call."),
(70,70,1,-2,"Justice remains the greatest power on earth. To that tremendous power alone will we submit."),
(71,71,3,3,"Best to take the moment present as a present for the moment."),
(72,72,4,-1,"Death is always and under all circumtances a tragedy, for if it is not, then it means that life itself has become one."),
...
(80,80,1,1,"If I had to live my life again, I'd make the same mistakes, only sooner."),
(81,81,2,1,"I want to be in Glee, but I'm told I'm not famous enough to be a cameo yet."),
(82,82,3,-2,"I've had a lot of experience in independent film, and about how to choose. You've got to be very discerning about where you put your five bucks, and where you cut and what you don't cut."),
(83,83,3,-2,"I'm a history nut."),
(84,84,4,0,"Democracy is ever eager for rapid progress, and the only progress which can be rapid is progress down hill."),
(85,85,3,3,"I don't want to achieve immortality through my work ... I want to achieve it through not dying."),
(86,86,2,0,"I drive an electric car."),
(87,87,3,-2,"Writers should be read but not seen. Rarely are they a winsome sight."),
(88,88,3,1,"To limit the press is to insult a nation; to prohibit reading of certain books is to declare the inhabitants to be either fools or slaves."),
(89,89,4,-3,"I think that, as with marriage, you just know when it's time to have kids."),
(90,90,5,-1,"The fact is that people are good, Give people affection and security, and they will give affection and be secure in their feelings and their behavior."),
(91,91,2,3,"Now this is not the end. It is not even the beginning of the end. But it is, perhaps, the end of the beginning."),
(92,92,3,-2,"I'd rather drive the yellow brick road, you wouldn't happen to know of a rental car place around."),
(93,93,2,3,"If I had been on Bowling for Dollars, I'd wind up owing them money."),
(94,94,4,0,"Dying is an art, like everything else. I do it exceptionally well. I do it so it feels like hell. I do it so it feels real. I guess you could say I've a call."),
(95,95,5,1,"Justice remains the greatest power on earth. To that tremendous power alone will we submit."),
(96,96,4,-2,"Best to take the moment present as a present for the moment."),
(97,97,5,-3,"Death is always and under all circumtances a tragedy, for if it is not, then it means that life itself has become one."),
(98,98,2,0,"Everything looks impossible for the people who never try anything."),
(99,99,5,0,"If I had my life to live over again, I don't think I would have the strength."),
(100,100,3,2,"I stopped dating for six months a year ago. Dating requires a lot of energy and focus.");
-- --------------------------------------------------------
