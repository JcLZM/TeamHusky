...
(106, 56, 81, 6,'5 Shocking Ways About drinking alcohol','It ought to be axiomatic in this country that every man must devote a reasonable share of his time to doing his duty in the Political life of the community.','Accepted'),
...
(116, 66, 91,16,'Programming : Step By Step Guide','It is this fate, I solemnly assure you, that I dread for you, when the time comes that you make your reckoning, and realize that there is no longer anything that can be done.','Accepted'),
(117, 67, 92,17,'29 Mistakes Most careless mistakes beginners Often Commit (And How To Avoid Them)','Cathargo Delenda Est!','Accepted'),
...
(128, 53, 78,28,'The Future Of Singapore In 2022 (And Why You Should Pay Attention)','And so, my fellow Americans: ask not what your country can do for you -- ask what you can do for your country.','Accepted'),
...
(131, 56, 81,31,'13 Shocking Tricks About Christmas','Were still pioneers. They, the members of the Challenger crew, were pioneers.','Accepted'),
...
(133, 58, 83,33,'Are You Ready To sleep? Here is How','I know it is hard to understand, but sometimes painful things like this happen.','Accepted'),
...
(135, 60, 85,35,'11 Shocking Tricks About Chinese new year','But has the last word been said? Must hope disappear? Is defeat final? No!','Accepted'),
...
(157, 57, 82,57,'29 Fool-Proof Secrets That Work For Fools','These are the boys of Pointe du Hoc. These are the men who took the cliffs. These are the champions who helped free a continent. These are the heroes who helped end a war.','Accepted'),
...
(172, 72, 97,72,'CSIT314: The Ultimate Things List','Blessed are they that mourn: for they shall be comforted.','Accepted'),
...
(176, 51, 76,76,'CSIT314 project Resolved In Just 25 Steps','Blessed are the pure in heart: for they shall see God.','Accepted'),
(177, 52, 77,77,'Top 11 Things Behind CSIT314','Blessed are the peacemakers: for they shall be called the children of God.','Accepted'),
...
(194, 69, 94,94,'Best 10 english Tactics For 2022','The poorest way to face life is to face it with a sneer. ','Accepted'),
(195, 70, 95,95,'Best 10 science Tactics For 2022','There are many men who feel a kind of twister pride in cynicism; ','Accepted'),
